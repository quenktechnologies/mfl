...
*/
var parser = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,4],$V1=[1,28],$V2=[1,23],$V3=[1,24],$V4=[1,25],$V5=[1,26],$V6=[1,27],$V7=[5,9,29],$V8=[9,23,24,25,26,27],$V9=[5,9,14,22,29],$Va=[14,22];
...
case 16:return 21;
break;
case 17:this.begin('SC_LITERAL');           return 27;
break;
case 18:return 28;
break;
case 19:this.popState();                    return 27;
break;
case 20:return 5;
break;
...
rules: [/^(?:\s+)/,/^(?:true)/,/^(?:false)/,/^(?::)/,/^(?:[0-9]+\.[0-9]+)/,/^(?:[0-9]+)/,/^(?:OR)/,/^(?:[^\[\]?<>:\s,"]+)/,/^(?:\[)/,/^(?:\])/,/^(?:,)/,/^(?:>=)/,/^(?:>)/,/^(?:<=)/,/^(?:<)/,/^(?:=)/,/^(?:\?)/,/^(?:")/,/^(?:[^"]*)/,/^(?:")/,/^(?:$)/,/^(?:.)/],
